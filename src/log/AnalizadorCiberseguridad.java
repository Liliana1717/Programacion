...
public class AnalizadorCiberseguridad {
    ...
    public static void main(String[] args) {
        ...
        List<String> listasIps = Arrays.asList(
                "192.168.1.1",
                "10.0.0.1",
                "192.168.1.1",
                "172.16.0.1",
        ...
        for ( String Ip : listasIps ){
         ataquesPorIP.put(Ip, ataquesPorIP .getOrDefault(Ip,0)+ 1);
        }
        ...
        for ( Log log : logsUnicos){
            ...
            String riesgo = nivelRiesgoZona.getOrDefault(log.ubicacion,"bajo");
            reporteRiesgo.putIfAbsent(riesgo,new ArrayList<>());
            reporteRiesgo.get(riesgo).add(log);
